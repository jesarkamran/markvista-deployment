...
function DashboardCard05() {
  ...
  return (
    <div className="col-span-full flex flex-col rounded-md border border-slate-200 bg-white shadow-lg sm:col-span-6 dark:border-slate-700 dark:bg-slate-800">
      <header className="flex items-center border-b border-slate-100 px-5 py-4 dark:border-slate-700">
        <h2 className="font-semibold text-slate-800 dark:text-slate-100">
          Real Time Value
        </h2>
        <Tooltip className="ml-2" size="md">
