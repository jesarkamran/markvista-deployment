...
function DashboardCard04() {
  ...
  return (
    <div className="col-span-full flex flex-col rounded-md border border-slate-200 bg-white shadow-lg sm:col-span-6 dark:border-[var(--color-background)] dark:bg-[var(--color-section)]">
