    ...
    if (id) {
      const fetchRiskProfile = async () => {
        try {
          ...
          toast.error("Error fetching risk profile:", error);
        }
      };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (id) {
        ...
        // Create a new risk profile
        const riskProfileData = JSON.parse(
          localStorage.getItem("riskProfileData"),
        );
        const createResponse = await fetch(
          "http://localhost:4000/api/riskprofiles",
          {
            ...
            body: JSON.stringify({
              ...
              description:
                riskProfileData?.description || "Default Description",
            }),
          },
        );
      ...
      toast.error("Error saving risk profile:", error);
    }
  };
          ...
          <div className="input-group">
            ...
            <div className="form-group">
              <div className="label-tooltip">
                ...
                <span
                  className="tooltip"
                  data-tooltip="Specify the amount of risk you're willing to take per trade. This field is required."
                >
                  ?
                </span>
              </div>
            ...
            <div className="form-group">
              <div className="label-tooltip">
                ...
                <span
                  className="tooltip"
                  data-tooltip="Specify the minimum acceptable risk to reward ratio for trades."
                >
                  ?
                </span>
              </div>
            ...
            <div className="form-group">
              <div className="label-tooltip">
                ...
                <span
                  className="tooltip"
                  data-tooltip="Specify the % percent of growth after which you will get a payout."
                >
                  ?
                </span>
              </div>
            ...
            <div className="form-group">
              <div className="label-tooltip">
                ...
                <span
                  className="tooltip"
                  data-tooltip="Specify the percentage increase in risk after reaching a winning checkpoint."
                >
                  ?
                </span>
              </div>
            ...
            <div className="form-group">
              <div className="label-tooltip">
                ...
                <span
                  className="tooltip"
                  data-tooltip="Specify the percentage decrease in risk after a losing trade."
                >
                  ?
                </span>
              </div>
          ...
          <div className="input-group">
            <div className="form-group">
              <div className="label-tooltip">
                ...
                <span
                  className="tooltip"
                  data-tooltip="Specify the maximum number of stop loss hits allowed per day."
                >
                  ?
                </span>
              </div>
            ...
            <div className="form-group">
              <div className="label-tooltip">
                ...
                <span
                  className="tooltip"
                  data-tooltip="Specify the amount of consecutive results after which you will get back to your initial risk percentage."
                >
                  ?
                </span>
              </div>
            ...
            <div className="form-group">
              <div className="label-tooltip">
                ...
                <span
                  className="tooltip"
                  data-tooltip="Specify the maximum risk percentage allowed per trade."
                >
                  ?
                </span>
              </div>
            ...
            <div className="form-group">
              <div className="label-tooltip">
                ...
                <span
                  className="tooltip"
                  data-tooltip="Specify the minimum risk percentage allowed per trade."
                >
                  ?
                </span>
              </div>
            ...
            <div className="form-group">
              <div className="label-tooltip">
                ...
                <span
                  className="tooltip"
                  data-tooltip="Specify the payout percentage for the trades."
                >
                  ?
                </span>
              </div>
